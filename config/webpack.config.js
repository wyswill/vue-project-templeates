  ...
  return {
    ...
    output       : {
      ...
      devtoolModuleFilenameTemplate: isEnvProduction ? (info) => path.relative(paths.appSrc, info.absoluteResourcePath)
                                                                     .replace(/\\/g, "/")
                                                     : isEnvDevelopment && ((info) => path.resolve(info.absoluteResourcePath)
                                                                                          .replace(/\\/g, "/")),
    ...
    resolve      : {
      ...
      plugins   : [
        PnpWebpackPlugin, new ModuleScopePlugin(paths.appSrc, [paths.appPackageJson, reactRefreshOverlayEntry])
      ],
    },
    resolveLoader: {
    ...
    plugins      : [
      ...
      new webpack.DllReferencePlugin({
                                       manifest: require(path.resolve(paths.appPublic, 'manifest.json')),
      ...
      new ForkTsCheckerWebpackPlugin({
                                       ...
                                       reportFiles                        : [
                                         "../**/src/**/*.{ts,tsx}", "**/src/**/*.{ts,tsx}", "!**/src/**/__tests__/**",
                                         "!**/src/**/?(*.)(spec|test).*", "!**/src/setupProxy.*", "!**/src/setupTests.*"
                                       ],
                                       silent                             : true,
