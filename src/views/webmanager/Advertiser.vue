  ...
  <div class="row information">
    ...
    >
       <el-form-item label="标题：" prop="name">
        <el-input v-model="ruleForm.name" placeholder="广告加盟"></el-input>
      </el-form-item>

      <el-form-item label="简述：" prop="content">
        <el-input type="textarea" v-model="ruleForm.content"  placeholder="专注提升广告投放效果,实现广告成本可控、效益可观、精准定位。"></el-input>
      </el-form-item>
       <el-form-item label="注册申请地址：" prop="seturl">
        <el-input v-model="ruleForm.seturl" placeholder="请输入注册申请网址"></el-input>
      </el-form-item>
...
import { getAdvertiser_api, Advertiserupdate_api } from "@/api/webmanager";
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        seturl:[
            { required: true, message: '注册申请网址不能为空', trigger: 'blur' },
