...
$root.hero = (function() {
    ...
    hero.hero_service = (function() {
         ...
         * @param {hero.hero_service.FindOneCallback} callback Node-style callback called with the error, if any, and Hero
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(hero_service.prototype.findOne = function findOne(request, callback) {
